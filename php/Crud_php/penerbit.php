<?php
    ...
    $penerbit = mysqli_query($mysqli, "SELECT penerbit.*, judul, qty_stok, harga_pinjam FROM penerbit
...
<a href="add_penerbit.php">Add New Penerbit</a><br/><br/>
    ...
    <?php  
        while($penerbit_data = mysqli_fetch_array($penerbit)) {         
            ...
            echo "<td>".$penerbit_data['qty_stok']."</td>";    
            echo "<td>".$penerbit_data['harga_pinjam']."</td>";    
