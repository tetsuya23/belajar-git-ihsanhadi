<?php
    ...
    $pengarang = mysqli_query($mysqli, "SELECT pengarang.*, judul, qty_stok, harga_pinjam FROM pengarang
...
<a href="add_pengarang.php">Add New Pengarang</a><br/><br/>
    ...
    <?php  
        while($pengarang_data = mysqli_fetch_array($pengarang)) {         
            ...
            echo "<td>".$pengarang_data['qty_stok']."</td>";    
            echo "<td>".$pengarang_data['harga_pinjam']."</td>";    
